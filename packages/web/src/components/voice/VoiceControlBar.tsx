    ...
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 opacity-0 translate-y-4 group-hover/voice:opacity-100 group-hover/voice:translate-y-0 transition-all duration-300 ease-out">
      <div className="flex items-center gap-1.5 rounded-full px-3 py-2 glass-bubble">
        ...
        <button
          ...
          title={(isSpaceMuted || isSpaceDeafened) ? (isMuted ? translate('runtime.expressions.VoiceControlBar.spaceMutedSelfMuted') : translate('runtime.expressions.VoiceControlBar.spaceMuted')) : isMuted ? translate('runtime.expressions.VoiceControlBar.unmuteM') : translate('runtime.expressions.VoiceControlBar.muteM')}
        >
        ...
        <button
          ...
          title={isSpaceDeafened ? translate('runtime.expressions.VoiceControlBar.spaceDeafened') : isDeafened ? translate('runtime.expressions.VoiceControlBar.undeafenD') : translate('runtime.expressions.VoiceControlBar.deafenD')}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {canSpeak && (
          <button
            ...
            title={isCameraOn ? translate('runtime.expressions.VoiceControlBar.turnOffCamera') : translate('runtime.expressions.VoiceControlBar.turnOnCamera')}
          >
            {isCameraOn ? (
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {canStream && (
          <button
            ...
            title={isScreenSharing ? translate('runtime.expressions.VoiceControlBar.stopSharing') : translate('runtime.expressions.VoiceControlBar.shareScreen')}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          title={translate("runtime.attributes.VoiceControlBar.videoQuality")}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          title={translate("runtime.attributes.VoiceControlBar.toggleChat")}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          title={voiceFullscreen ? translate('runtime.expressions.VoiceControlBar.exitFullscreenEsc') : translate('runtime.expressions.VoiceControlBar.fullscreen')}
        >
          {voiceFullscreen ? (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          title={translate("runtime.attributes.VoiceControlBar.disconnect")}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">

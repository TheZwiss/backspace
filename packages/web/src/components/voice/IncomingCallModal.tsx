      ...
      <div className="relative glass-modal call-refraction rounded-lg w-[340px] overflow-hidden animate-fade-in animate-slide-up">
        ...
        <div className="relative z-[2] p-8 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-[14px] text-txt-tertiary mt-1"><Trans i18nKey="ui.IncomingCallModal.incomingVoiceCall">Incoming Voice Call...</Trans></p>
          </div>
          ...
          <div className="flex items-center gap-6 mt-2">
            ...
            <button
              ...
              title={translate("runtime.attributes.IncomingCallModal.decline")}
            >
            ...
            <button
              ...
              title={translate("runtime.attributes.IncomingCallModal.accept")}
            >

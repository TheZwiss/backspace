      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-txt-tertiary text-sm">
            <Trans i18nKey="ui.VoiceGrid.waitingForOthersToJoin">Waiting for others to join...</Trans>
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div
          ...
          title={translate("runtime.attributes.VoiceGrid.clickToReturnToGridView")}
        >
          ...
          <button
            ...
            title={translate("runtime.attributes.VoiceGrid.backToGridView")}
          >
            <svg
              width="16"
              height="16"
            ...
            <span className="text-xs font-medium"><Trans i18nKey="ui.VoiceGrid.grid">Grid</Trans></span>
          </button>
        </div>
        ...
        {otherTiles.length > 0 && (
          <div className="flex justify-center flex-shrink-0 py-1">
            <button
              ...
              title={stripHidden ? translate('runtime.expressions.VoiceGrid.showMembers') : translate('runtime.expressions.VoiceGrid.hideMembers')}
            >
              ...
              <span>{stripHidden ? translate('runtime.expressions.VoiceGrid.showMembers2') : translate('runtime.expressions.VoiceGrid.hideMembers2')}</span>
            </button>
          </div>
        )}

...
const sections: SectionDef[] = [
  {
    id: 'general',
    get label() { return translate('runtime.static.MobileInstancePanel.general'); },
    icon: (
  ...
  {
    id: 'registration',
    get label() { return translate('runtime.static.MobileInstancePanel.registration'); },
    icon: (
  ...
  {
    id: 'federation',
    get label() { return translate('runtime.static.MobileInstancePanel.federation'); },
    icon: (
  ...
  {
    id: 'streaming',
    get label() { return translate('runtime.static.MobileInstancePanel.streaming'); },
    icon: (
      <svg className="w-5 h-5 text-txt-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    id: 'storage',
    get label() { return translate('runtime.static.MobileInstancePanel.storage'); },
    icon: (
      <svg className="w-5 h-5 text-txt-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    id: 'users',
    get label() { return translate('runtime.static.MobileInstancePanel.users'); },
    icon: (
      <svg className="w-5 h-5 text-txt-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function MobileInstancePanel() {
  ...
  return (
    <div className="flex flex-col h-full bg-surface-base">
      <MobileScreenHeader title={translate("runtime.attributes.MobileInstancePanel.instance")} rightActions={<TransferIndicator />} />
